            ...
            <form class="row g-3" method="POST" action="{{URL('/')}}">
                ...
                <fieldset class="shadow-sm p-4">
                    ...
                    <div class="row p-2 align-content-center">
                        <div class="col-md-2">
                            <input type="text" name="prefixo" class="form-control" placeholder="Prefixo" required>
                        </div>
                        _
                        <div class="col-md-2">
                        ...
                        _
                        <div class="col-md-3">
                            <input type="text" name="cod_ait" class="form-control" placeholder="Número da Autuação" required>
                        </div>
            ...
            <form class="row g-3" method="POST" action="{{URL('/')}}">
                ...
                <fieldset class="shadow-sm p-4">
                    ...
                    <div class="row p-2 align-content-center mb-6">
                        <div class="col-md-3">
                            <input type="text" name="cod_ait" class="form-control" placeholder="Código da Infração">
                        </div>
                    </div>
